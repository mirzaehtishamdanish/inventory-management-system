    ...
    <body class="bg-dark">
        ...
        <div class="container">
            <div class="card card-register mx-auto mt-5">
                ...
                <div class="card-body">  
                    <form:form method="POST" action="${contextPath}/addNewVendor/add" modelAttribute="vendorForm" class="form-signin">

                        <spring:bind path="id">
                                    <!--<div class="form-group ${status.error ? 'has-error' : ''}">-->
                                    <%--<form:input type="text" id="id" path="id" class="form-control" placeholder="id" required="required" autofocus="autofocus"></form:input>--%>
